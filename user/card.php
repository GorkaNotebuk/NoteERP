...
if (($action == 'create') || ($action == 'adduserldap'))
{
    /* ************************************************************************** */
    /*                                                                            */
    /* Affichage fiche en mode creation   | Creación de un nuevo usuario                                       */
    /*                                                                            */
    /* ************************************************************************** */
	...
	if ($conf->salaries->enabled && ! empty($user->rights->salaries->read))
	{
	    ...
	    print "</tr>\n";
         ...
         // horas extra
        print '<tr><td>Precio horas extras</td>';
        print '<td>';
        print '<input size="8" type="text" name="salaryextra" value="'.GETPOST('salaryextra').'">';
        print '</td>';
        print "</tr>\n";

	    // Salary
	    print '<tr><td>Salario mensual</td>';
	    print '<td>';
...
else
{
    /* ************************************************************************** */
    /*                                                                            */
    /* View and edition   (Edicion de una ficha de usuario)                                                         */
    /*                                                                            */
    /* ************************************************************************** */
            ...
            if (! empty($conf->salaries->enabled) && ! empty($user->rights->salaries->read))
            {
			    ...
			    print "</tr>\n";
                 ...
                 // horas extra
                    print '<tr><td>Precio horas extras</td>';
                    print '<td>';
                    print ($object->salaryextra!=''?price($object->salaryextra,'',$langs,1,-1,-1,$conf->currency):'');
                    print '</td>';
                    print "</tr>\n";
            ...
            else
          {
            ...
            if (! empty($conf->salaries->enabled) && ! empty($user->rights->salaries->read))
            {
                ...
                // horas extra
                    print '<tr><td>Precio horas extras</td>';
                    print '<td>';
                    print '<input size="8" type="text" name="salaryextra" value="'.price2num(GETPOST('salaryextra')?GETPOST('salaryextra'):$object->salaryextra).'">';
                    print '</td>';
                    print "</tr>\n";
