...
if (! $sortfield) $sortfield="denominacion";
...
print_fiche_titre("Listado de tipo de documentos");

$sql="SELECT docID, denominacion, validezdias FROM ".MAIN_DB_PREFIX."tiposdedocumentos ";
...
if ($resql)
{
    ...
    print_liste_field_titre("Nombre de documento",$_SERVER["PHP_SELF"],"denominacion",$param,"","",$sortfield,$sortorder);
    //multicompany
    ...
    print_liste_field_titre("Validez del documento (En días)",$_SERVER["PHP_SELF"],"validezdias",$param,"",'align="center"',$sortfield,$sortorder);
    //print_liste_field_titre($langs->trans("DateCreation"),$_SERVER["PHP_SELF"],"fechacreacion",$param,"",'align="right"',$sortfield,$sortorder);
    print "</tr>\n";
    $var=True;
    ...
    while ($i < $num)
    {
        ...
        print "<tr ".$bc[$var].">";
        print '<td><a href="card.php?id='.$obj->docID.'">'.img_object($langs->trans("ShowGroup"),"list").' '.$obj->denominacion.'</a>';
        /*if (! $obj->entity)
        {
        ...
        print '<td align="center">'.$obj->validezdias.'</td>';


       //print '<td align="right" class="nowrap">'.dol_print_date($db->jdate($obj->fechacreacion),"day").'</td>';
        print "</tr>\n";
        $i++;
    }
    print "</table>";
